...
def run_transformer_lm(
    ...
    trans = transformer.Transformer_lm(
        d_model=d_model,
        num_heads=num_heads,
        d_ff=d_ff,
        theta=rope_theta,
...
def run_cross_entropy(
    ...
    """
    import cs336_basics.assignment1.cross_entrpy
    return cs336_basics.assignment1.cross_entrpy.cross_entropy(inputs, targets)
...
def run_gradient_clipping(
    ...
    """
    from cs336_basics.assignment1 import grad_clip
    grad_clip.grad_clip(parameters, max_l2_norm)
...
def run_get_lr_cosine_schedule(
    ...
    """
    from cs336_basics.assignment1.cos_lr import lr_cosine_schedule
